...
- `index.html` — main page (countdown, details, fees, getaway, gallery)
- `register.html` — team registration form (emails the tournament inbox via FormSubmit)
- `images/` — web-optimized photos

> This repo contains **public website files only**. Team data, rosters, payments, and contacts live in a separate private repository.
